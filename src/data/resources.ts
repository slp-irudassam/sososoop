...
export const paidResources: Resource[] = [
  ...
  },
  {
    ...
    description:
      "언어재활사 국가시험 CBT(컴퓨터 기반 시험) 형식을 그대로 재현한 온라인 실전 연습 프로그램 이용권입니다. 실제 시험과 동일한 교시 구성·제한시간·문항 유형으로 연습하고, 문제마다 상세한 오답풀이·해설을 제공합니다. 이용기간은 결제일로부터 12개월이며, 기간 중 추가·업데이트되는 문항도 그대로 이용할 수 있습니다. (실제 기출이 아닌 창작 연습 문항)",
    category: "학습",
    fileType: "웹앱",
    type: "paid",
    price: 14900,
  ...
  },
  {
    ...
    title: "한글놀이 이용권",
    description:
      "난독·읽기부진 아동을 위한 한글 블렌딩 학습 도구 이용권입니다. 아동이 배운 초성·중성·종성만 켜두면 블렌딩 보드·읽기 게임·학습자료 만들기가 모두 그 범위 안에서 돌아갑니다. 아동별 프로필로 진도를 따로 관리하고, 의미 단어·무의미 단어·문장을 자동 생성해 바로 인쇄하거나 글씨연습장으로 이어서 만들 수 있어요. 이용기간은 결제일로부터 12개월이며, 기간 중 추가·업데이트되는 기능도 그대로 이용할 수 있습니다.",
    category: "학습",
    fileType: "웹앱",
    type: "paid",
    price: 7900,
